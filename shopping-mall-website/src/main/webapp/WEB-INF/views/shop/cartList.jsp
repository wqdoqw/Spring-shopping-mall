...
<body>
	...
	<c:if test="${fn:length(cartList) == 0}">
		...
		<p style="text-align: center; font-weight:bold; font-size:16px; ">현재 카트에 상품이 없습니다.</p>
	</c:if>
	<c:if test="${fn:length(cartList) > 0}">
		<div class="box">
			<h3 class="goods-title">전체 카트 상품</h3>
			...
			<div class="delBtn">
				<button type="button" class="selectDelete_btn btn btn-default" style=" 
				background-color: #ff6766; color: white;">선택 삭제</button>
	...
	<script>
		$(".selectDelete_btn").click(function() {
			...
			<c:forEach items="${cartList}" var="cartList">
				...
				<div class="delete">
 				<button type="button" class="delete_${cartList.cartNumber}_btn btn btn-default" data-cartNumber="${cartList.cartNumber}" style="margin-top: 20px; background-color: #ff6766; color: white;">삭제</button>
		...
		<div class="listResult" style="margin-bottom:200px;">
 				<div class="sum">
